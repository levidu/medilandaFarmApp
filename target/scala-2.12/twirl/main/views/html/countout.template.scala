...
Seq[Any](format.raw/*2.1*/("""<html>
        ...
        <center>
            ...
            <div class="container">
                <form action=""""),_display_(/*56.32*/routes/*56.38*/.HomeController.count_out_save()),format.raw/*56.70*/("""" method="POST">
                    ...
                    <br>
                    <br>
                    <input type="text" class="form-control" placeholder="EGG COUNT | හොඳ බිත්තර" name="egg_count" id="egg_count" required>
                    <br>
                    <input type="text" class="form-control" placeholder="DAMAGE COUNT | හානි බිත්තර" name="damage_count" id="damage_count" required>
                    <br>
                    <input type="text" class="form-control" placeholder="DIRTY COUNT | අපිරිසිදු බිත්තර" name="dirty_count" id="dirty_count" required>
                    <br>
                    <input type="text" class="form-control" placeholder="DAMAGED BY USER | මගේ හානි බිත්තර" name="damaged_on_counter" id="damaged_on_counter" required>
                    <br>
                    <br>
                    <br>
                    <br>
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: 0c5daf6eb7a3b8164d0e2d37763fecf4a7390e14
