...
Seq[Any](format.raw/*2.1*/("""<html>
        ...
        <center>
            ...
            <div class="container">
                <form action=""""),_display_(/*56.32*/routes/*56.38*/.HomeController.count_out_save()),format.raw/*56.70*/("""" method="POST">
                    ...
                    <br>
                    <br>
                    <input type="text" class="form-control" placeholder="EGG COUNT" name="egg_count" id="egg_count">
                    <br>
                    <input type="text" class="form-control" placeholder="DAMAGE COUNT" name="damage_count" id="damage_count">
                    <br>
                    <input type="text" class="form-control" placeholder="DIRTY COUNT" name="dirty_count" id="dirty_count">
                    <br>
                    <input type="text" class="form-control" placeholder="DAMAGED BY USER" name="damaged_on_counter" id="damaged_on_counter">
                    <br>
                    <br>
                    <br>
                    <br>
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: d08cb667ec1c733bb876946032fdbc4df37dc04a
